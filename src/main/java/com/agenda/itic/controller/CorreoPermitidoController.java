...
public class CorreoPermitidoController {
    ...
    public ResponseEntity<CorreoPermitidoResponseDto> createCorreoPermitido(@Valid @RequestBody CorreoPermitidoRequestDto correoPermitidoStr) {
        CorreoPermitidoResponseDto createdCorreoPermitido = correoPermitidoService.createCorreoPermitido(correoPermitidoStr);
